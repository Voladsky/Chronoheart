...
public class FlyingEmenyFollow : EnemyBehaviour
{
    ...
    void FollowPlayer(Vector3 project)
    {
        ...
        //move to player
        else  MoveInDirection((int)project.normalized.x,(int)project.normalized.y);
    }
    ...
    private void MoveInDirection(int _directionX,int _directionY)
    {
        idleTimer = 0;
        anim.SetBool("moving", true);

        //Make enemy face direction
        enemy.localScale = new Vector3(Mathf.Abs(initScale.x) * _directionX,
